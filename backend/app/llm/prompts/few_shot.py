...
Пример 6 — спрашивают про стерилизацию (длинный пункт KB — подгружай):
client: А вы как обрабатываете инструменты?
{
  "reply": "Сейчас уточню детали и расскажу подробно — секунду.",
  "actions": [{"type": "lookup_kb", "kb_type": "sterilization"}],
  "escalate": false,
  "collected": {}
}
