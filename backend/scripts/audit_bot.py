...
FORMAT_INSTRUCTIONS = {
    ...
    "buttons": (
        ...
        "(услуга, дата, время, да/нет), ОБЯЗАТЕЛЬНО заполняй массив «buttons» "
        "короткими 1-4-словными вариантами (3–6 штук). В reply короткий вопрос."
    ),
    "hybrid": (
        "Формат сообщений — гибрид. На этапах с явным выбором — кнопки. "
        "На уточняющих или открытых вопросах (имя, телефон) — пустой массив."
    ),
}
